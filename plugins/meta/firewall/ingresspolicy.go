...
func setupIngressPolicy(conf *FirewallNetConf, prevResult *current.Result) error {
...
func setupIngressPolicySameNetwork(conf *FirewallNetConf, prevResult *current.Result) error {
...
func teardownIngressPolicy(conf *FirewallNetConf, prevResult *current.Result) error {
	switch conf.IngressPolicy {
	case "", IngressPolicyOpen:
		// NOP
		return nil
